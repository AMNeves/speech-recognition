...
GOOGLE_SPEECH_URL = 'https://speech.googleapis.com/$discovery/rest?version=v1/recognize?xjerr=1&client=chromium&pfilter=2&lang=%s&maxresults=6' % (LANG_CODE)
...
def audio_int(num_samples=50):
    ...
    print (" Finished ")
    print (" Average audio intensity is " +  str(r))
    stream.close()
    p.terminate()
    return r
